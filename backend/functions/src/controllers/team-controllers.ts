...
export const getAllTeams = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: "Got all teams", teams: teamResponse.rows })
}
...
export const getStandings = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: "Got standings!", standings: standingsResponse.rows})
}
...
export const getStandingsExpanded = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: "Got expanded standings!", standings: standingsResponse.rows})
}
...
export const getStandingsDivisions = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: "Got division standings!", standings: standingsResponse.rows})
}
...
export const getConferenceTeams = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got all teams by conference.`, east: eastResponse.rows, west: westResponse.rows })
}
...
export const getDivisionTeams = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got all teams by division.`, atlantic, central, southeast, northwest, pacific, southwest })
}
...
export const getSingleTeam = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got data for the ${teamResponse.rows[0].full_name}`, team: teamResponse.rows[0], games: lastTenResponse.rows, players: topPlayersResponse.rows[0], history: historyResponse.rows[0] })
}
...
export const getTeamStatsRegularSeason = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got stats for team #${team_id}`, player_stats: statsResponse.rows, team_stats: teamStatsResponse.rows[0] })
}
...
export const getTeamStatsPlayoffs = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got stats for team #${team_id}`, player_stats: statsResponse.rows, team_stats: teamStatsResponse.rows[0], team_leaders: teamLeadersResponse.rows[0] })
}
...
export const getTeamScheduleRegularSeason = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Retrieved schedule for team ${team_id}`, schedule: scheduleResponse.rows })
}
...
export default async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Retrieved roster for team ${team_id}`, roster: rosterResponse.rows });
};
...
export const getTeamHistory = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Retrieved roster for team ${team_id}`, history: historyResponse.rows[0] })
}