...
export const getAllPlayers = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got all players`, players: playersResponse.rows })
}
...
export const getHomePlayers = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got players`, awardWinners: awardWinnersResponse.rows, popularPlayers: popularPlayersResponse.rows})
}
...
export const getPlayerStatLeaders = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got season stats leaders!`, averageLeaders: averageResponse.rows[0], totalLeaders: totalResponse.rows[0] })
}
...
export const getGameHighLeaders = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (seasonType === 'regular-season') {
        ...
        return res.status(200).json({ message: `Got game stats leaders!`, gameLeaders: gameStatResponse.rows[0] })
    } else {
        // playoffs
...
export const getSinglePlayer = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got player #${player_id}`, player: player, currentTeam: currentTeamResponse.rows[0], stats: statResponse.rows[0] })
}
...
export const getSinglePlayerOverview = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got overview stats for player #${player_id}`, teamStandings: teamStandingsResponse.rows, lastFive: lastFiveGamesResult.rows, splits: playerSplitsResponse.rows[0] })
}
...
export const getSinglePlayerStatsView = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got stats for player #${player_id}`, regular_season_stats: playerRegularSeasonStatsResponse.rows[0], playoff_stats: playerPlayoffStatsResponse.rows[0] })
}
...
export const getSinglePlayerSplitsView = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got splits for player #${player_id}`, splits: playerSplitsResponse.rows[0] || null })
}
...
export const getSinglePlayerGameLogView = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got game logs for player #${player_id}`, regular_season_log: regularSeasonGameLogResponse.rows, playoff_log: playoffGameLogResponse.rows.length > 0 ? playoffGameLogResponse.rows : undefined })
}