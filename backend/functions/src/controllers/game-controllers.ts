...
export const getGameByID = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got data for game #${game_id}`, game: gameResponse.rows[0], standingsData: standingsResponse.rows[0] })
}
...
export const getTeamStats = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got team stats for game #${game_id}`, gameSeries: gameSeriesResponse.rows, gameLeaders: gameLeadersResponse.rows })
}
...
export const getGameBoxScore = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({ message: `Got box scores for game #${game_id}`, players: boxScoreResponse.rows })
}