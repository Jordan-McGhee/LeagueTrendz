...
SELECT
	...
	p.avg_turnovers,
	CASE
        WHEN p.avg_turnovers = 0 THEN NULL
        ELSE ROUND(((p.avg_ast * 1.0) / p.avg_turnovers), 1)
    END AS ast_to_ratio,
